  ...
  <div class="email-container">
    ...
    <div class="email-content">
      ...
      <div class="button-container">
        <a href="http://localhost:5173/verify-email/{{$user->verification_token }}" target="_blank">Confirmer mon compte</a>
      </div>

      <p>Si le bouton ne fonctionne pas, copiez et collez ce lien dans votre navigateur :</p>
      <p><a href="http://localhost:5173/verify-email/{{$user->verification_token }}">http://localhost:3000/verify-email/{{$user->verification_token }}</a></p>
    </div>
